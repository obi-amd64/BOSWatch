...
apt-get -y install git cmake build-essential libusb-1.0 qt5-qmake qtbase5-dev libpulse-dev libx11-dev sox python3-pip >> $boswatch_install_path/setup_log.txt 2>&1
